  ...
  return (
    <section className="relative overflow-hidden bg-ink pt-32 text-white">
      <Image
        ...
        sizes="100vw"
      />
      <div className="absolute inset-0 bg-gradient-to-r from-brand-blue via-brand-blue/90 to-brand-pink/40" />
      <Container className="relative pb-24 pt-12">
        <div className="max-w-3xl">
          <p className="mb-5 text-sm uppercase tracking-[0.2em] text-cyanline">
            {eyebrow}
          </p>
