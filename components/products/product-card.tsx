        ...
        <div className="mt-5 flex flex-col gap-2 sm:flex-row">
          {onQuickView ? (
            <button
              ...
              className="inline-flex min-h-10 flex-1 items-center justify-center gap-2 rounded-full border border-slate-200 px-4 py-2 text-sm text-slateblue transition hover:bg-medical"
            >
