...
export function HeroCarousel() {
  ...
  useEffect(() => {
    const interval = window.setInterval(() => setIndex((current) => (current + 1) % slides.length), 6200);
    ...
    <section className="relative min-h-[92vh] overflow-hidden bg-ink text-white">
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-ink via-ink/80 to-slateblue/35" />
      ...
      <Container className="relative flex min-h-[92vh] items-center pt-20">
        <div className="max-w-3xl">
          <motion.p
            ...
            className="mb-5 text-sm font-bold uppercase tracking-[0.24em] text-cyanline"
          >
