  ...
  return (
    <footer className="bg-brand-blue text-white">
      <Container className="py-16">
                ...
                return (
                  ...
                  >
                    <span className="flex items-center gap-3">
                      ...
                      <span>
                        <span className="block text-xs uppercase tracking-[0.16em] text-white/44">
                          {social.label}
                        </span>
            ...
            <div className="mt-5 space-y-3">
              {navItems.map((item) => (
                <Link
                  key={item.href}
                  href={item.href}
                  className="block text-sm text-white/68 hover:text-white py-1"
                >
                  {item.label}
                </Link>
              ))}
        ...
        <div className="mt-12 border-t border-white/10 pt-6 text-sm text-white/55 text-center sm:text-left">
          Copyright 2026 Stanmax Laboratories Private Limited. All rights
          reserved.
        </div>
      </Container>
    </footer>
